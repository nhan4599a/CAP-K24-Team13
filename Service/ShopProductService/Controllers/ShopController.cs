...
namespace ShopProductService.Controllers
{
    ...
    {
        private readonly static List<ShopDTO> FakeShops = new()
        {
            new ShopDTO
            { 
                Id = 0,
            ...
            new ShopDTO
            {
                Id = 1,
                Name = "Future World",
                Image = "https://futureworld.com.vn/media/logo/stores/1/FW_Black_logo_1.png" 
            },
            new ShopDTO
            {
                Id = 2,
            ...
            new ShopDTO
            {
                Id = 4,
                Name = "Bitis",
                Image = "https://marathonhcmc.com/wp-content/uploads/2021/02/bitis-1-1.png" 
            },
            new ShopDTO
            {
                Id = 5,
                Name = "Converse",
                Image = "https://drake.vn/image/catalog/H%C3%ACnh%20content/converse-chuck-taylor-all-star-logo-play/Converse-chuck-taylor-all-star-logo-play-7.jpg"
            }
        };
